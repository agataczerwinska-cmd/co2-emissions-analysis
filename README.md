...
To test whether the visual relationships above hold up statistically (rather than being an artifact of chart scaling), correlation coefficients were calculated and plotted against a scatter view:
